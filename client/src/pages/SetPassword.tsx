 ...
 * SetPassword.tsx
 *
 * Used by users who were registered via webhook (no password was set at creation).
 * They receive an email with a link to /set-password?token=... and land here.
 *
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(
          data.error ||
            "This link has expired or is invalid. Please contact your administrator to resend the invitation."
        );
        return;
      }
      setSuccess(true);
      toast.success("Password set! Welcome to the Liability Defense System.");
    } catch {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Invalid Invitation Link</h2>
          <p className="text-gray-500 mb-6">
            This link is missing a token. Please use the link from your welcome email, or contact
            your administrator.
          </p>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1a1a19] tracking-tight">
          ...
          <CardHeader>
            ...
            <CardDescription>
              {success
                ...
                : "Your account is ready. Choose a password to activate it."}
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-4">
                ...
                <p className="text-xs text-gray-400">
                  This link expires in 48 hours. If it has expired, use "Forgot Password" on the
                  sign-in page.
                </p>
              </CardContent>
              <CardFooter>
