...
import {
  ...
  Star, Settings, History, Bell, BarChart3, Key, Globe,
} from "lucide-react";
...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV_SECTIONS: NavSection[] = [
    ...
    /* ⚠️ PERMANENT SECTION — do not remove, merge, or hide unless user explicitly requests it */
    {
      id: "mappingTracking",
      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto space-y-0.5">
        ...
        {isAdmin && (
          <>
            ...
            <NavLink item={{ href: "/admin/resource-links", label: "Resource Links", icon: <Globe size={18} /> }} />
          </>
        )}
      </nav>
