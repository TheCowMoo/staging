// US States and Canadian Provinces (Ontario focus) for facility address dropdowns
...
export const ONTARIO_PROVINCES = [
...
export const ALL_STATE_PROVINCES = [
  { group: "United States", items: US_STATES },
  { group: "Canadian Provinces", items: ONTARIO_PROVINCES },
];
